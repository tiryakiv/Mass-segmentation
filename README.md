...
To run the codes yourself, download all of them. Download the mammograms from the BCDR website: https://bcdr.eu/ , and downsample the mammograms and distribute the mammograms to train, valid, and test folders. The patient ids of each folder is provided in the supplementary materials document. Folder hiearchy for mass segmentation is shown below. Apply the breast segmentation, automatic removal and downsampling, and mass segmentation codes. 
