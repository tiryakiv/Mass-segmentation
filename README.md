...
To run the codes yourself, download all of them. Download the mammograms from the BCDR website: https://bcdr.eu/, and downsample the mammograms and distribute the mammograms to train, valid, and test folders. The train, validation, testing patient ids are provided in the Supplementary Materials document. Folder hiearchy for mass segmentation is shown below. Apply the breast segmentation, automatic removal and downsampling, and mass segmentation codes, respectively. 
