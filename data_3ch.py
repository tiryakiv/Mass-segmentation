# Unet Pretrained Data File written on Feb 26, 2021
...
def testGenerator(test_path,num_image = 6,target_size = (512,512,3),flag_multi_class = False,as_gray = False):
...
#def labelVisualize(num_class,  color_dict, img):  #one-hot label code
